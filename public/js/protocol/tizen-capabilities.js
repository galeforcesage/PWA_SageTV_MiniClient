 ...
 * (MPEG-2 video, AC-3 / E-AC-3 audio, MPEG-PS/TS containers). The runtime probe
...
const PROFILE_4 = {
  ...
  // MP2 included alongside MP3 for MPEG-PS/DVB broadcast audio (Samsung lists
  // MPEG audio support); PCM = Samsung "LPCM".
